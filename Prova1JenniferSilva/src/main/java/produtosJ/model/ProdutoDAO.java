...
public class ProdutoDAO {
	...
	public List<Produto> buscarPorNome(String nome){
		...
		try {
			...
			while (resultado.next()){
				Produto produto = new Produto(resultado.getLong("ID"),resultado.getString("NOME"),Double.parseDouble(resultado.getString("PRECO")),Integer.parseInt(resultado.getString("QUANTIDADE")));
	...
	public Produto buscarPorId(Long id){
		...
		try {
			...
			produto = new Produto(resultado.getLong("ID"),resultado.getString("NOME"),Double.parseDouble(resultado.getString("PRECO")),Integer.parseInt(resultado.getString("QUANTIDADE")));
			//produto.setId(resultado.getLong("ID"));
			//produto.setNome(resultado.getString("NOME"));
			//produto.setPreco(Double.parseDouble(resultado.getString("PRECO")));
			//produto.setQuantidade(Integer.parseInt(resultado.getString("QUANTIDADE")));
